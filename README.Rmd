...
```{r ti, fig.width=50, fig.height=25}
...
```{r spiCalib1, fig.width=50, fig.height=60}
library(zoo)
library("ggplot2")
library(gridExtra)
library(grid)
...
```{r spiCalib2, fig.width=50, fig.height=50}
...
```{r spiCalib3, fig.width=50, fig.height=50}
...
```{r spiPlot, fig.width=50, fig.height=25}
mp1 <- ggplot(hspi, aes()) +
  theme_classic(base_size=80) +
  #theme_classic() +
...
```{r hdiPlotCal, fig.width=50, fig.height=25}
...
```{r hdiPlotFft, fig.width=50, fig.height=25}
...
```{r hhiPlot, fig.width=50, fig.height=25}
library("RColorBrewer")
mp2 <- ggplot() +
  theme_classic(base_size=80) +
  #theme_classic() +  
...
```{r hdiPlot, fig.width=50, fig.height=25}
library("RColorBrewer")
library("ggplot2")
...
```{r fftPlot, fig.width=50, fig.height=25}
...
```{r winterPlot, fig.width=50, fig.height=25}
...
```{r summerPlot, fig.width=50, fig.height=25}
...
```{r extractPeriods, fig.width=50, fig.height=25}

## https://github.com/climdata/drought2019/blob/03a18c900d0000e2c98697764910b6b9f1bef32a/csv/hhi_1500_2xxx.csv
## hhi_orig <- read.csv("https://github.com/climdata/drought2019/blob/03a18c900d0000e2c98697764910b6b9f1bef32a/csv/hhi_1500_2xxx.csv", sep=",")
...
```{r plotPeriods, fig.width=50, fig.height=25}
